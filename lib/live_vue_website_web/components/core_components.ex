defmodule LiveVueWebsiteWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveVueWebsiteWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveVueWebsiteWeb.Gettext, "errors", msg, opts)
    end
  end
