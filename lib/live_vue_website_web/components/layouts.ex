defmodule LiveVueWebsiteWeb.Layouts do
    ...
    <div class="drawer lg:drawer-open">
      ...
      <div class="drawer-content">
        <div class="min-h-screen bg-landing-deep text-landing-text font-[Inter,system-ui,sans-serif]">
          ...
          <%!-- Mobile header --%>
          <header class="lg:hidden sticky top-0 z-40 flex items-center gap-4 px-4 py-3 border-b border-landing-border/50 bg-landing-bg/80 backdrop-blur-sm">
            <label for="examples-drawer" class="btn btn-ghost btn-sm btn-square text-landing-muted">
        ...
        <aside class="w-72 min-h-full border-r border-landing-border/50 bg-landing-deep lg:bg-landing-bg/50 lg:backdrop-blur-sm">
          <div class="sticky top-0 h-screen flex flex-col">
            ...
            <div class="shrink-0 px-4 pt-4 lg:pt-6 pb-4 flex items-center justify-between gap-2">
              ...
              <label
                for="examples-drawer"
                class="lg:hidden btn btn-ghost btn-sm btn-square text-landing-muted"
              >
                <.icon name="hero-x-mark" class="size-5" />
              </label>
            </div>

            <.examples_sidebar_content
  ...
  attr :examples_nav, :list, required: true
  attr :active_examples, :list, required: true
