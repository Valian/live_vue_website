        ...
        <div class="grid gap-4">
          <div class="p-6 bg-landing-card/50 border border-landing-border rounded-xl">
            ...
            <.example_snippet code={
              ~s|<.vue v-component="SsrControl" v-socket={@socket} />|
            } />
          </div>
          ...
          <div class="p-6 bg-landing-card/50 border border-landing-border rounded-xl">
            ...
            <p class="text-landing-muted text-sm leading-relaxed mb-3">
              When using browser-only APIs like
              <code class="text-vue bg-vue/10 px-1.5 py-0.5 rounded">window</code>,
              <code class="text-vue bg-vue/10 px-1.5 py-0.5 rounded">navigator</code>, or
              <code class="text-vue bg-vue/10 px-1.5 py-0.5 rounded">document</code>,
